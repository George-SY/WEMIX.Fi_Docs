...
13. “프라이빗 키”란, PLAY WALLET, WEMIX WALLET의 주소와 1:1로 매칭되는 코드(숫자와 문자를 임의로 조합하여 생성)를 의미하며, PLAY WALLET, WEMIX WALLET의 모든 서명을 진행하기 위한 중요한 키입니다. 프라이빗 키는 서명 권한이 있으므로 외부에 노출된 경우 타인이 토큰의 전송 등 유효한 서명을 할 수 있게 됩니다. 취급에 각별한 주의가 필요합니다.
...
5.  위믹스플레이를 통한 코인 및 게임 정보의 제공
    ...
    회사는 위믹스플레이를 통하여 각종 디지털 자산의 가치나 거래 현황(시세)에 대한 정보제공 서비스를 제공할 수 있습니다. 다만, 제공하는 정보에 대한 완전성 또는 무결성을 보증하지는 않습니다. 이용자 또는 회원은 언제든지 서비스를 중단하거나 이용을 거부할 수 있습니다.
...
1.  이용자 및 회원의 의무
    ...
    1. 가)다른 이용자 또는 회원의 계정 및 비밀번호를 도용, 부정하게 사용하는 행위
    2. 나)게시판 등 공개된 장소나 서비스에 음란물을 게재하거나 음란사이트를 연결(링크)하는 행위
    3. 다)회사 또는 제3자의 저작권 등 기타 권리를 침해하는 행위
    4. 라)서비스와 관련된 설비의 오작동이나 정보 등의 파괴 및 혼란을 유발시키는 행위
    5. 마)다른 회원의 개인정보를 수집, 저장, 공개하는 행위
    6. 바)자신 또는 타인에게 재산상의 이익을 주거나 타인에게 손해를 가할 목적으로 허위 정보를 유통시키는 행위
    7. 사)관련 법령에 의하여 전송 또는 게시가 금지되는 정보(컴퓨터 프로그램 포함)의 전송 또는 게시 행위
    8. 아)회사 또는 관계사의 직원이나 운영자를 가장하거나 사칭하여 또는 타인의 명의를 도용하는 행위
    9. 자)기타 불법 행위나 서비스 운영에 방해가 되는 행위
    10. 차)디지털 자산의 전송, 스왑 등 위믹스 플랫폼, PLAY WALLET, WEMIX WALLET 등에서의 서비스와 관련된 프라이빗 키, 로그인 계정, 로그인 패스워드, 프라이빗 키 패스워드, 비밀문구 등 개인정보 일체(이하 "생성정보")에 관한 관리 및 보호책임은 이용자 및 회원에게 있습니다. 이를 제3자가 이용하도록 해서는 안 됩니다.
    11. 카)이용자 또는 회원은 생성정보가 도용, 누출, 분실 또는 훼손되는 경우, 탈중앙화 서비스 특성상 회사는 어떠한 도움도 드릴 수 없습니다.
    12. 타)이용자 또는 회원이 PLAY WALLET, WEMIX WALLET 또는 생성정보 대한 권한을 상실하고 백업을 별도로 저장하지 않아 이용할 수 있었던 모든 디지털 자산에 대한 권한이 상실된 경우, 그로 인한 결과의 책임은 전적으로 이용자 및 회원에게 있으며 회사는 그에 대한 책임이 없음을 인정하고 동의합니다.
    13. 파)상실된 디지털 자산은 되돌릴 수 없습니다.
    14. 하)이용자 또는 회원이 관련 법령, 회사의 모든 약관 또는 정책을 준수하지 않는다면, 회사는 이용자 또는 회원의 위반행위 등을 조사할 수 있고, 아래와 같이 여러분의 서비스 이용을 잠시 또는 계속하여 중단될 수 있습니다.
2.  서비스 이용 중단

    | 항목                                                                         | 제재 기준                                                                                           | 제재 조치       |             |             |             |
    | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------- | ----------- | ----------- | ----------- |
    | 1차                                                                         | 2차                                                                                              | 3차          | 4차          |             |             |
    | 컨텐츠 악용/버그 사용                                                               | 위믹스 서비스 내 비정상적인 컨텐츠 및 버그 등을 악용하여 시스템 및 위믹스 서비스 운영에 심각한 영향을 미친 행위                                | 영구 접속제한     |             |             |             |
    | 부적절한 채팅                                                                    | 도배/욕설 등의 채팅 사용                                                                                  | 경고          | 3일 계정 접속제한  | 10일 계정 접속제한 | 30일 계정 접속제한 |
    | 상업적 광고, 허위사실 유포, 개인정보 유출, 반사회적, 비윤리적인 내용 등의 채팅 사용                          | 경고                                                                                              | 3일 계정 접속제한  | 10일 계정 접속제한 | 30일 계정 접속제한 |             |
    | 회사 직원 사칭                                                                   | 사칭을 통해 다른 이용자 또는 회원에게 혼란을 주거나 주려한 모든 행위                                                         | 영구 접속 제한    |             |             |             |
    | 사기 행위                                                                      | 다른 사람을 속여 아이템 등을 편취 하거나 부당한 이득을 취하는 행위 및 이를 시도하려 한 행위가 명백히 확인될 경우                               | 영구 접속 제한    |             |             |             |
    | 계정도용                                                                       | 계정도용으로 신고된 자산을 거래했거나, 보유 중인 계정                                                                  | 영구 접속 제한    |             |             |             |
    | 허위 신고 사항                                                                   | 사실이 아닌 내용으로 계정도용 및 사기/불량이용자 및 회원 신고 등의 내용을 허위로 작성하는 행위                                          | 10일 계정 접속제한 | 30일 계정 접속제한 | 영구 접속 제한    |             |
    | 작명                                                                         | 관계법령 및 사회질서에 반하는 사항과 욕설 및 음담패설 등의 내용으로 아이디 등의 위믹스 서비스 내 이름을 생성한 경우                              | 영구 접속 제한    |             |             |             |
    | 불법 프로그램 사용, 유포                                                             | 불법 프로그램 및 위믹스 서비스에서 제공하지 않는 소프트웨어/하드웨어를 사용하여 서비스에 영향을 주는 행위를 하거나 이러한 행위를 위한 방법을 유포한 내용이 확인되는 경우 | 영구 접속 제한    |             |             |             |
    | 비정상적 서비스접속                                                                 | 모니터링 및 시스템에 의해 비정상적인 접속이 확인된 경우                                                                 | 영구 접속 제한    |             |             |             |
    | 운영 및 서비스 이용 방해                                                             | 회사의 경고를 무시하거나 정상적인 운영을 방해하는 모든 행위                                                               | 3일 접속제한     | 10일 접속제한    | 30일 접속제한    | 영구 접속제한     |
    | 위에서 정의된 행위들 이외에, 위믹스 서비스 내 컨텐츠를 이용하여 고의적/반복적으로 타인의 정상적인 서비스 이용을 방해하는 모든 행위 |                                                                                                 |             |             |             |             |

    1. \-위 이용 제한 항목의 적용은 사안에 따라 회사의 판단에 의해 조정 될 수 있습니다.
    2. \-각기 다른 정책 위반 시 상위 수준의 제한이 적용되거나, 가중하여 제재를 받을 수 있습니다.
    3. \-위믹스 서비스 내에서 비신사적인 행위를 하거나 혹은 서비스 질서유지를 방해하는 이용자 또는 회원에게 1차 제재 조치가 아닌, 2차 이상의 제재 조치를 취할 수 있습니다.
    4. \-위 항목에 구체적으로 명시되지 않은 사항일지라도 서비스 내외적으로 심각한 문제가 발생/발생할 수 있다고 판단할 경우 회사의 이용 약관에 의거 이용 제한이 진행될 수 있습니다.
3.  이용자 및 회원의 책임
